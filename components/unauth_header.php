<header class="main__header" style="margin-top: -17px;">
  <div class="container">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Registration</a>
            <ul class="dropdown-menu">
              ...
              <li><a href="t_registration.php">Registration as Teacher</a></li>
            </ul>
          </li>
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Login</a>
            <ul class="dropdown-menu">
              <li><a href="s_login.php">Student Login</a></li>
              <li><a href="t_login.php">Teacher Login</a></li>
